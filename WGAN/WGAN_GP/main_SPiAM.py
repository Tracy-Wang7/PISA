...
sys.stdout = Logger("/workspace1/ow120/DDAM/Graph_NN_case/cifar_10/Adabelief-Optimizer/PyTorch_Experiments/wgan-gp/wgan_3.txt")
...
opt.outf = 'SPiAM' + '-wgan_3' + '-betas{}-{}'.format(opt.beta1, opt.beta2) + '-eps{}-{}'.format(opt.eps, opt.eps_sqrt) \
...
squared_gradients = {name: torch.zeros_like(param) for name, param in netD.named_parameters()}
