...
class SVHN_custom(data.Dataset):
    ...
    def __build_truncated_dataset__(self):
        if self.train is True:
            ...
            svhn_dataobj = SVHN(self.root, 'train', self.transform, self.target_transform, download=False)
            ...
            svhn_dataobj = SVHN(self.root, 'test', self.transform, self.target_transform, download=False)
            data = svhn_dataobj.data
            target = svhn_dataobj.labels
