...
'''def adjust_learning_rate(learning_rate, epoch, step_size=25, gamma=0.5, reset = False):
    ...
    if epoch % step_size==0 and epoch>0 and epoch <21:
        learning_rate *= gamma
    #if epoch % step_size==0 and epoch>51 and epoch <100:
    #if epoch % 10==0 and epoch>51 and epoch <101:
        #learning_rate *= gamma
        #learning_rate *= 0.95
...
#### faster but get best performance around 94.72
'''def adjust_learning_rate(learning_rate, epoch, step_size=25, gamma=0.5, reset = False):

    if epoch % 3==0 and epoch>4 and epoch <61:
        learning_rate *= gamma
    #if epoch % step_size==0 and epoch>0 and epoch <11:
        #learning_rate *= gamma
...
#### wait for testing....  testing performance worse than last one
'''def adjust_learning_rate(learning_rate, epoch, step_size=25, gamma=0.5, reset = False):

    if epoch % 2==0 and epoch>4 and epoch <51:
        learning_rate *= gamma
    #if epoch % step_size==0 and epoch>0 and epoch <11:
        #learning_rate *= gamma
    #if epoch % step_size==0 and epoch>61 and epoch <100:
