...
sys.stdout = Logger("/workspace0/ow120/DDAM/Graph_NN_case/cifar_10/Adabelief-Optimizer/PyTorch_Experiments/classification_cifar10/densenet_1.txt")
...
def main():
    ...
    for epoch in range(start_epoch + 1, args.total_epoch):
        ...
        if test_acc > best_acc:
            ...
            torch.save(model.state_dict(), "/workspace0/ow120/DDAM/Graph_NN_case/cifar_10/Adabelief-Optimizer/PyTorch_Experiments/classification_cifar10/DenseNet_best_model/model_1.pth")
