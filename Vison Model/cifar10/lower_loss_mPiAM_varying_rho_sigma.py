...
sys.stdout = Logger("/workspace0/ow120/DDAM/Graph_NN_case/cifar_10/Adabelief-Optimizer/PyTorch_Experiments/classification_cifar10/vgg_2.txt")
...
def generate_W_global_normalized(num_batches, W_n_list, P_n_list, tau_lr, alpha, list_nomalized):
    ...
    for epoch in range(start_epoch + 1, args.total_epoch):
        ...
        for iter_idx, (images, target) in enumerate(train_loader):
            ...
            with torch.no_grad():
                ...
                W_global = generate_W_global_normalized(args.num_gpu, W_b_initial, P_b_initial, sigma_lr_current, alpha_b, normalized_factor)
                for param, w in zip(model.parameters(), W_global):
                    param.copy_(w)
